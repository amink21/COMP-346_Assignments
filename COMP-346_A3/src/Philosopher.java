...
public class Philosopher extends BaseThread {
	...
	public void run() {
        for (int i = 0; i < DiningPhilosophers.DINING_STEPS; i++) {
            ...
            if (random.nextBoolean()) { //random vallue 
                DiningPhilosophers.soMonitor.requestTalk(getTID()); // Pass the getTID() argument
                talk(); //talking
                DiningPhilosophers.soMonitor.endTalk(getTID()); // Pass the getTID() argument
            }
