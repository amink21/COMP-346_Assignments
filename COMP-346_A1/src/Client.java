...
public class Client extends Thread{ 
     ...
     */
     public void sendTransactions()
     {
         ...
         {  
            while( objNetwork.getInBufferStatus().equals("full")){	/* Alternatively, busy-wait until the network output buffer is available */
       		 Thread.yield();
       	 }
    ...
    {   
    	...
    	if (getClientOperation().equals("sending")) {
    		...
    		System.out.println("\n Terminating sending client thread - " + " Running time " + (sendClientEndTime - sendClientStartTime) + " milliseconds");
    		...
    		System.out.println("\n Terminating receiving client thread - " + " Running time " + (receiveClientEndTime - receiveClientStartTime) + " milliseconds");
