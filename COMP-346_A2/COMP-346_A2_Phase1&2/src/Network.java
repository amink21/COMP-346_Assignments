...
public class Network extends Thread {
    ...
    private static Semaphore sending;
    private static Semaphore receiving;
     ...
     */
     Network( )
      { 
         ...
         sending = new Semaphore(maxNbPackets);
         receiving = new Semaphore(0);
         transferIn = new Semaphore(0);
         transferOut = new Semaphore(maxNbPackets);
     ...
     */
        public static boolean send(Transactions inPacket)
        {
        		  ...
        		  transferIn.release();
         	 		 ...
         	 		 System.out.println("Interrupted on send");
         	 	 }
     ...
     */
         public static boolean receive(Transactions outPacket)
        {
        	 	 ...
        	 	 try {
        	 		 ...
        	 		 System.out.println("Interrupted on receive");
        	 	 }
     ...
     */
         public static boolean transferOut(Transactions outPacket)
        {
        	 	...
        	 	try {
       	 		 ...
       	 		 System.out.println("Interrupted on transferOut");
       	 	 }
       ...
       public static boolean transferIn(Transactions inPacket)
        {
    	   		 ...
    	   		 try {
        	 		 ...
        	 		 System.out.println("Interrupted on transferIn");
        	 	 }
